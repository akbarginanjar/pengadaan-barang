        ...
        <div class="col-md-12">
            <form role="form" action="{{ route('supplier.store') }}" method="post">
                ...
                <div class="form-group @error('no_telepon') has-error @enderror">
                    ...
                    <input type="number" name="no_telepon" class="form-control @error('no_telepon') is-invalid @enderror" placeholder="No Telepon">
                    @error('no_telepon')
                        <span class="invalid-feedback" style="color: red" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="form-group  @error('alamat') has-error @enderror">
                    <label>Alamat</label>
                    <textarea name="alamat" class="form-control  @error('alamat') is-invalid @enderror" rows="5" placeholder="Alamat"></textarea>
                    @error('alamat')
                        <span class="invalid-feedback" style="color: red" role="alert">
                            {{ $message }}
                        </span>
